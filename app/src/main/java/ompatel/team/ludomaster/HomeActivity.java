...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // home layout views
    ConstraintLayout topNavBar, exitAppLayout, settingspopupbg, statisticslayout, firstLoginLayout, guestprofilecreateoreditlayout, passnplaylayout, passnplayclassiclayout, p2layout, p3layout, p4layout, pnpteamuplayout, computerlayout, computerclassiclayout;
    ImageView profiletop,computer,passnplay,exitgamebtn;
    TextView usernamehomescreen,coinscount1,coinscount2,playerNameBtnComTextView,currentActiveTextView;
    EditText mainNamesEditText;
    TextView editTextOKBtn;
    
    // settings layout views
    // statistics layout views
    TextView stcsusernametextview; ImageView stcsprofpic;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setting listeners for first login screen views (Disabled)
        /*
        findViewById(R.id.imageView23).setOnClickListener(noInternetOnClick);
        findViewById(R.id.imageView26).setOnClickListener(noInternetOnClick);
        findViewById(R.id.imageView27).setOnClickListener(noInternetOnClick);
        */
    ...
    private void initViews() {
        ...
        usernamehomescreen = findViewById(R.id.usernamehomescreen);
    ...
    public void openPortfolio(View v) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://omlalitpatel.netlify.app"));
